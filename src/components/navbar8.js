        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text26">/</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text22">/courses</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text24">/resources</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text25">/contact</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Enroll Now</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Get in Touch</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text21">
                                  Welcome to Forexperts Academy Pro, your
                                  gateway to Forex trading expertise.
                                </span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text27">Courses</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text19">
                                  Explore our range of specialized courses
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text16">
                                  Access valuable resources to stay informed and
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text20">
                                  Get in touch with us for any inquiries or to
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text21">
                            Welcome to Forexperts Academy Pro, your gateway to
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text19">
                            Explore our range of specialized courses designed to
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text17">Resources</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text16">
                            Access valuable resources to stay informed and make
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text20">
                            Get in touch with us for any inquiries or to start
...
Navbar8.defaultProps = {
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1583916011819-e4b81836bb57?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTI1Nzc2OHw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage1: 'https://www.teleporthq.io',
  page4: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1517059224940-d4af9eec41b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTI1Nzc2OXw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  action1: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1596729495038-38b020551ef0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTI1Nzc2OXw&ixlib=rb-4.0.3&q=80&w=1080',
  logoAlt: 'Forexperts Academy Pro Logo',
  link3: undefined,
  link4: undefined,
  page3ImageAlt: 'Resources Image',
  link1: undefined,
  page2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1634704760994-96e3ccf2ae85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTI1Nzc2OHw&ixlib=rb-4.0.3&q=80&w=1080',
}
